...
def main():
    ...
    if device in {'GW5A-25A', 'GW5AST-138C'} and gw5a_bsrams:
        ...
        bslib.write_bitstream(args.output, main_map, db.cmd_hdr, db.cmd_ftr, args.compress, extra_slots, bsram_init_map, cols_iterator, is_gw5a_138=(device == 'GW5AST-138C'))
