...
wirenames.update({n: f"5A25{n}" for n in range(545, 553)}) # GW5A-25A need these
wirenames.update({n: f"5A25{n}" for n in range(556, 564)}) # GW5A-25A need these
...
clknames.update({n: f"UNK{n}" for n in range(261, 1001)})
